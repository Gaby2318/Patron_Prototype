...
#define UE_PROJECT_NAME Patron_Prototype
#define UE_TARGET_NAME Patron_PrototypeEditor
#define UE_MODULE_NAME "Patron_Prototype"
...
#define PATRON_PROTOTYPE_API DLLEXPORT
